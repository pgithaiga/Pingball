board name = portalWorldB gravity = 10 friction1=0.02 friction2 = 0.02
#Board portalWorld good to check if portal works correctly with otherboard A
...
# Portals
portal name=portalA x=4 y=11 otherPortal=portalB
portal name=portalB x=7 y=3 otherBoard = portalWorldA otherPortal=portalA
portal name=portalC x=10 y=10 otherPortal=portalA
portal name=portalD x=16 y=10 otherPortal=Nothing
portal name=portalE x=18 y=1 otherBoard = portalWorldA otherPortal=portalD
