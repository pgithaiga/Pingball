...
# representation of the screenshot in the project handout.
  ...
  # ADD PORTAL YAY'
  portal name=Alpha x=19 y=12 otherBoard=boardGG otherPortal=Beta
  portal name=Beta x=5 y=6 otherPortal=Alpha
  
  #circleBumper name=Alpha x=19 y=12 
  #circleBumper name=Beta x=5 y=4 
  ...
  keydown key=a action=FlipR1
  keyup key=a action=FlipR1
